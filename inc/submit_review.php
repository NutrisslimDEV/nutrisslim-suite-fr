    ...
    function filter_submit_review_page_content( string $content ): string {
        ...
        <div class="mass-reviews container container-px">
            <div class="review-intro">
                <h1 class="bold"><?php echo __('Votre avis nous tient à cœur', 'nutrisslim-suite'); ?></h1>
                <p><?php echo __('Chez Nature\'s Finest, nous nous efforçons toujours de fournir les meilleurs produits et services à nos précieux clients. Souhaitez-vous évaluer votre dernier achat ?', 'nutrisslim-suite'); ?></p>
                <p><?php echo __('En guise de remerciement pour votre temps, nous vous enverrons un cadeau spécial avec votre commande!', 'nutrisslim-suite'); ?></p>
                <h4><?php echo __('Votre commande', 'woocommerce'); ?></h4>
                ...
                <h4><?php echo __('Évaluez et laissez un avis sur votre achat', 'nutrisslim-suite'); ?></h4>
            </div>
            <div class="form">
                <div class="nf-review_form">
                    <div class="review_fields">
                        ...
                        <textarea name="review_review" id="review_text" cols="30" rows="5" placeholder="<?php echo __('Dites-nous ce que vous en pensez','nutrisslim-suite'); ?>"></textarea>
                        <button id='send_reviews'><?php echo __("Envoyer","woocommerce"); ?></button>
                    </div>
                </div>
            </div>
        </div>
