        ...
        <div
            ...
            <p style="line-height: 19px; font-size: 12px; text-align: center; margin: 0; margin-bottom:10px;"
                align="left"><span style="line-height: inherit; font-size: 14px;"><strong
                        style="line-height: inherit;"><?php echo __('Évaluez Nature’s Finest et obtenez une récompense!', 'nutrisslim-suite'); ?></strong></span>
            </p>
            <p
                ...
                <?php echo __('Nous cherchons toujours à améliorer nos produits et services, et nous apprécions grandement votre avis.', 'nutrisslim-suite'); ?>
            </p>
            <p
                style="margin: 0; margin-bottom:10px; font-size: 14px; line-height: 21px; color: #555555; font-family: 'Oxygen', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;">
                <?php echo __('<b>Évaluez votre expérience avec nous</b> – et en guise de remerciement, nous vous enverrons un <b>cadeau spécial</b> avec votre commande!', 'nutrisslim-suite'); ?>
            </p>
            ...
            <p
                ...
                <a href="<?php echo $trusted_review_link; ?>" target="_blank"
                    ...
                    bgcolor="#1fb25a">
                    <?php echo __('ÉVALUEZ LA BOUTIQUE MAINTENANT', 'nutrisslim-suite'); ?>
                </a>
            </p>
            <p
                ...
                <a href="<?php echo $trusted_review_link; ?>" target="_blank"
                    style="text-decoration:none!important; color: #555555!important;"><?php echo __('Voir plus', 'nutrisslim-suite'); ?>
                    <img align="center" alt="Image" border="0" class="center autowidth "
                        ...
                        title="Image" width="82" height="14"> <?php echo __('avis!', 'nutrisslim-suite'); ?></a>
            </p>
        </div>
    </div>
</div>