                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="line-height: 24px; font-size: 12px; text-align: left; margin: 0;"><span
                                        style="font-size: 14px;"><strong><?php echo __('Informations client', 'woocommerce')?>:</strong></span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <p style="line-height: 19px; font-size: 12px; text-align: left; margin: 0;"><span
                                        style="font-size: 14px;"><strong><?php echo __('Détails de livraison', 'woocommerce')?>:</strong></span>
                                </p>
                            </div>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
