...
class Nutrisslim_Landing_Quantity_Selector extends Widget_Base {
    ...
    protected function render() {
		...
		if ($singlePriceWithTax >= $free_shipping_threshold) {
            $shippingCost = __('Livraison gratuite', 'nutrisslim-suite');
        } else {
            $shippingCost = floatval(str_replace(',', '.', $shippingCost));
            $shippingCost = __('Frais de livraison', 'nutrisslim-suite') . ' ' . wc_price($shippingCost);
        }
                ...
                <div class="slick-track" style="opacity: 1; width: 450px;">
                    <div class="slide slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false"
                        ...
                        <div class="slider-flex">
                            <span class="slide-content"><?php _e('FORMULAIRE DE COMMANDE', 'nutrisslim-suite'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 pt-3 icon-check icon-primary-color text-center">
                ...
                <div class="col-12 pt-3 shipping-details">
                    <?php
                            ...
                            echo sprintf( __('%s sous 3 à 4 jours ouvrables', 'nutrisslim-suite'), $delivery_type, $courier, $from, $to ) . '</p>';
                            ?>
                </div>

                <?php if (!empty($quantities[1]['price']) || !empty($quantities[2]['price'])) { ?>
                <div class="text-center cta-notice">
                    <h3><?php _e('Achetez plus, économisez plus', 'nutrisslim-suite'); ?></h3>
                </div>
                <?php } else {
                            ...
                            echo '<p class="redno">' . __('Prix normal', 'woocommerce') . ':<br /><span><s>' . wc_price($regular_price) . '</s></span></p>';
...
<div id="upsell-block" class="style-a<?php echo $upsell_block_option == 'upsell-block-a' ? '' : ' d-none'; ?>"
    ...
    <?php
                    $custom_titles = array(
                        1 => !empty($package_1_text) ? $package_1_text : __('Commandez 1 paquet', 'nutrisslim-suite'),
                        2 => !empty($package_2_text) ? $package_2_text : __('Commandez 2 paquets', 'nutrisslim-suite'),
                        3 => !empty($package_3_text) ? $package_3_text : __('Commandez 3 paquets', 'nutrisslim-suite')
                    );

                    $custom_titles2 = array(
                        1 => __('1x paquet', 'nutrisslim-suite'),
                        2 => __('2x paquets', 'nutrisslim-suite'),
                        3 => __('3x paquets', 'nutrisslim-suite')
                    );
                    ...
                    foreach ($quantities as $key => $item) {
                        ...
                        if ($key == 1) {
                            echo '<div class="text-center cta-notice mobile"><h3>' . __('Achetez plus, économisez plus', 'nutrisslim-suite') . '</h3></div>';
                        }
        ...
        <div class="offer-container">
            ...
            <div class="bottom">
                                ...
                                <label for="checked0<?php echo $num; ?>">
                                    ...
                                    <?php 
                                                            if ($consumption_period && $duration > 0) {
                                                                echo '<p style="font-size: smaller; padding-left: 20px; font-weight:300; padding-top: 10px"> pour ' . $duration . ' jours</p>';
                                                            }
                                                            ?>
                                </label>
                            </div>
                            <div class="price">
                                <div class="price-old price-small">
                                    <span class="line-through precrtano">
                                        <?php echo sprintf(__('Prix régulier %s', 'nutrisslim-suite'), wc_price($regular_price * $num)); ?>
                                    </span>
                                </div>
                ...
                <div class="offer_shipping">
                    ...
                    <?php _e('Livraison gratuite', 'nutrisslim-suite'); ?>
                </div>
                <?php } ?>
                ...
                <div class="offer_shipping">
                    ...
                    <?php _e('Cadeau gratuit', 'nutrisslim-suite'); ?>
                </div>
                <?php } ?>
            </div>
        </div>
        ...
        <?php if ($upsell_block_option == 'upsell-block-c') : ?>
            ...
            <div id="upsell-block" class="style-c<?php echo $upsell_block_option == 'upsell-block-c' ? '' : ' d-none'; ?>"
                ...
                foreach ($quantities as $key => $item) {
                    ...
                    if ($key == 1) {
                        echo '<div class="text-center cta-notice mobile"><h3>' . __('Acheter plus, économiser plus', 'nutrisslim-suite') . '</h3></div>';
                    }
                            ...
                            <div class="offer-container">
                                ...
                                <div class="bottom">
                                    ...
                                    <span class="price-per-product-text">
                                        ...
                                        <?php _e('/ par produit', 'nutrisslim-suite'); ?>
                                    </span>
                                            </div>
                                        ...
                                        <div class="offer-left">
                                            ...
                                            type="checkbox" ' . ($key == 0 ? 'checked' : '') .
                                                    ...
                                                    <label for="checked0_c_<?php echo esc_attr($num); ?>">
                                                        ...
                                                        if ($consumption_period && !empty($duration)) {
                                                            echo '<p style="font-size: smaller; padding-left: 20px; font-weight:300; padding-top: 5px; font-family: "Fira Sans", Sans-serif"> pendant' . esc_html($duration) . ' jours</p>';
                                                        }
                                                        ?>
                                                    </label>
                                                </div>
                                            ...
                                            <span class="line-through precrtano regularofferc">
                                                <?php
                                                echo sprintf(
                                                    __('Prix normal %s', 'nutrisslim-suite'),
