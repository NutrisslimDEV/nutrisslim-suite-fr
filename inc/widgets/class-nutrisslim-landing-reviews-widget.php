...
class Nutrisslim_Landing_Reviews_Widget extends Widget_Base {
    ...
    protected function render() {
        ...
        if ($n > 1) {
            ...
            echo '<h2>Expériences de nos utilisateurs</h2>';
                            ...
                            <div class="revSlid">
                                ...
                                <div class="revContent">
                                    ...
                                    <div class="udata">
                                        ...
                                        <div class="checker"><span class="check"><img src="/wp-content/uploads/2024/03/whiteCheck.png" alt="check"></span> <?php echo __('Utilisateur vérifié', 'nutrisslim-suite'); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
